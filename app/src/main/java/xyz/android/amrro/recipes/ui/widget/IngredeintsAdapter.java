...
/**
 * Created by amrro <amr.elghobary@gmail.com> on 8/18/17.
 */

public final class IngredeintsAdapter extends ArrayAdapter {
    ...
    public IngredeintsAdapter(@NonNull Context context, @NonNull List<Ingredient> ingredients) {
